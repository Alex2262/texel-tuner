...
constexpr SCORE_TYPE KNIGHT_MOBILITY[8]  = {0};
constexpr SCORE_TYPE BISHOP_MOBILITY[13] = {0};
constexpr SCORE_TYPE ROOK_MOBILITY[14]   = {0};
constexpr SCORE_TYPE QUEEN_MOBILITY[27]  = {0};
