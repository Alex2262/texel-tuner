...
constexpr SCORE_TYPE KNIGHT_MOBILITY[9]  = {0};
constexpr SCORE_TYPE BISHOP_MOBILITY[15] = {0};
constexpr SCORE_TYPE ROOK_MOBILITY[16]   = {0};
constexpr SCORE_TYPE QUEEN_MOBILITY[29]  = {0};
...
constexpr SCORE_TYPE BACKWARDS_PAWN_PENALTY = 0;
